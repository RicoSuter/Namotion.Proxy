...
/// <param name="DataType">The DataType attribute. Its status is never transiently bad, because a transient status aborts the load before the type is inferred.</param>
