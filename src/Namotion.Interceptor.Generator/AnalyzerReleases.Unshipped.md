...
NI0005 | Namotion.Interceptor | Error | Property re-declares a member already implemented by the base class
...
NI0008 | Namotion.Interceptor | Error | More than one member provides the same property name
